...
public class ArithmeticCoder implements CompressionAlgorithm  {
    ...
    public byte[] compress( byte[] data ) throws IOException  {
        ...
        // Mesmo seletor Krichevsky–Trofimov do RangeCoder: compara custo estimado
        // (entropia + overhead do cabeçalho) do modelo estático contra o adaptativo.
